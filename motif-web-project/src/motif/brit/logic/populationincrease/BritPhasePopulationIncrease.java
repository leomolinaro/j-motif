package motif.brit.logic.populationincrease;
...
import motif.brit.logic.phase.ABritPhase;
...
public class BritPhasePopulationIncrease extends ABritPhase {
	...
	public class BritSelectAreaToPlaceUnitRequestIO extends ABritSelectAreaSvgRequestIO<BritLandArea> {
	...
	public IBritIO start (ABritPhasePopulationIncreaseIO IO, BritContext context) {
