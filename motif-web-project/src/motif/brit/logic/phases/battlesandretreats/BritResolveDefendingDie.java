...
public class BritResolveDefendingDie {
	...
	private class BritSelectUnitToEliminateRequestIO extends ABritSelectUnitRequestIO<BritUnit> {
	...
	public IBritIO start(ABritResolveDefendingDieIO IO, BritContext context) {
		...
		if (availableUnits == null || availableUnits.isEmpty()) {
			...
			return new BritSelectUnitToEliminateRequestIO(availableUnits, IO);
		}
	}

	public IBritIO next(BritSelectUnitToEliminateRequestIO prevIO, ABritResolveDefendingDieIO IO, BritContext context) {
