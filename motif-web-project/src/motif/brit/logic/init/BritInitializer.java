...
import motif.brit.state.BritArea.BritAreaType;
import motif.brit.state.BritBorder;
import motif.brit.state.BritBorder.BritBorderType;
...
import motif.brit.state.BritNation.BritColor;
import motif.brit.state.BritPlayer;
import motif.brit.state.BritSeaArea;
import motif.brit.state.BritTimelineElement;
...
public class BritInitializer {
	...
	private HashMap<String, String> getSvgDMap () {
		...
		try {
			InputStream is = getClass().getClassLoader().getResourceAsStream ("motif/brit/resources/britannia-map.svg");
