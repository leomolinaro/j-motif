...
public class BritPhaseBattlesAndRetreats {
	...
	public class BritSelectAreaToResolveBattleRequestIO extends ABritSelectAreaRequestIO<BritLandArea> {
		...
		@Getter @Setter private BritLandArea area;
	...
	@RequiredArgsConstructor
	public class BritThrowAttackingDiceRequestIO extends ABritContinueRequestIO {
		@Override public void accept(IBritIOVisitor visitor) { visitor.visit(this); }
		@Getter private final ABritPhaseBattlesAndRetreatsIO parent;
	...
	@RequiredArgsConstructor
	public class BritThrowDefendingDiceRequestIO extends ABritContinueRequestIO {
		@Override public void accept(IBritIOVisitor visitor) { visitor.visit(this); }
		@Getter private final ABritPhaseBattlesAndRetreatsIO parent;
	...
	@RequiredArgsConstructor
	public class BritResolveAttackingDieIO extends ABritResolveAttackingDieIO {
		@Override public void accept(IBritIOVisitor visitor) { visitor.visit(this); }
	...
	@RequiredArgsConstructor
	public class BritResolveDefendingDieIO extends ABritResolveDefendingDieIO {
		@Override public void accept(IBritIOVisitor visitor) { visitor.visit(this); }
	...
	@RequiredArgsConstructor
	public class BritAttackerSelectRetreatIO extends ABritSelectUnitAreaSvgRequestsIO<BritUnit, BritArea> {
		@Override public void accept(IBritIOVisitor visitor) { visitor.visit(this); }
		@Getter @Setter private BritUnit unit;
	...
	@RequiredArgsConstructor
	public class BritDefenderSelectRetreatIO extends ABritSelectUnitAreaSvgRequestsIO<BritUnit, BritLandArea> {
		@Override public void accept(IBritIOVisitor visitor) { visitor.visit(this); }
		@Getter @Setter private BritUnit unit;
		@Getter @Setter private BritLandArea area;
		@Getter @Setter private double svgX;
