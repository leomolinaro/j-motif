package motif.brit.logic.movement;
...
public class BritPhaseMovement {
	...
	public class BritSelectAreaToMoveUnitRequestIO extends ABritSelectAreaSvgRequestIO<BritLandArea> {
	...
	@RequiredArgsConstructor
	public class BritSelectUnitToMoveRequestIO extends ABritSelectUnitRequestIO<BritUnit> {
		@Override public void accept(IBritIOVisitor visitor) { visitor.visit(this); }
