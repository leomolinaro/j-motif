...
public class AngCharacterCard extends AngMarshallCard {
	...
	public AngCharacterCard (AgotSetCard setCard, int setId, String title, AngFaction faction, boolean loyal, int cost, boolean unique, IcB iconsBuilder, Integer strength, TB text) {
