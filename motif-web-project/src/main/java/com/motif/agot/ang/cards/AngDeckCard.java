...
public abstract class AngDeckCard extends AngTextCard {
	...
	public AngDeckCard (AgotPack pack, int setId, String title, AngType type, AngFaction faction, boolean loyal, AngText text) {
		super (pack, setId, title, type, faction, text);
		this.loyal = loyal;
	} // AngDeckCard
